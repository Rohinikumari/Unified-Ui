...
(function() {
    ...
    ClientControllerCache.prototype.getClient = function(options) {
        ...
        for (var i = 0; i < this.val.length; i++) {
            var ctr = this.val[i];
            if (ctr.id === id) {
                console.log("returning same client id")
                return ctr.client;
            }
        }
        console.log("new client id is passed")
    ...
    MQTTClient.prototype.computeUrl = function(){
        ...
        console.log("INFO: secreteKey :"+secretKey);
        console.log("INFO: accessKey :"+accessKey);
